...
public class CortexM0SysTick extends Observable {
	...
	/*
	 * impuls licznika: -enableFlag =1 inaczej licznik nie dziaĹ‚a -odliczanie
	 * do zera od wartosci w CVR -gdy CVR rĂłwne 0 => bit countFlag= 1 oraz
	 * przeĹ‚aduj CVR na wartosc podanÄ… w RVR -gdy tickingFlag = true i CVR !=0
	 * wyslij przerwanie
	 */
	public void impuls() {
		if (!enableFlag)
